 ...
 */
package net.siegmar.japtproxy.packages.rpm;

import net.siegmar.japtproxy.packages.AbstractRepoPackageVersionComparator;
import org.apache.commons.lang3.CharUtils;

/**
 * The VersionComparator is responsible for comparing rpm package versions. This
 * is required for sorting a list of rpm packages from the same program with
 * different versions.
 *
 * @author Thomas Pasch
 */
public class RpmPackageVersionComparator extends AbstractRepoPackageVersionComparator {
